// Compact, dependency-free Porter stemmer (classic 1980 algorithm).
// Exposes window.stemWord(word) -> stem. Pure and self-contained so it
// can be unit-tested in isolation. Input is expected lowercased; we
// lowercase defensively anyway.
(function () {
    "use strict";
    ...
    window.stemWord = stemWord;
    window.__stemWord = stemWord;
})();
